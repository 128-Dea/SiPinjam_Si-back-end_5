                ...
                <div class="card-body">
                    <form action="{{ route('dashboard.pengguna.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" nama="nama" value="{{ old('nama') }}" required>
                            @error('nama')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nim') is-invalid @enderror" id="nim" nama="nim" value="{{ old('nim') }}">
                            @error('nim')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('jurusan') is-invalid @enderror" id="jurusan" nama="jurusan" value="{{ old('jurusan') }}">
                            @error('jurusan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
