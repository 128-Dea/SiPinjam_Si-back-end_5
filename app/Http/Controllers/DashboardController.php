...
class DashboardController extends Controller
{
    ...
    public function storePengguna(Request $request)
    {
        ...
        return redirect()->route('dashboard.pengguna.index')->with('success', 'Pengguna berhasil ditambahkan');
    }
    ...
    public function updatePengguna(Request $request, $id)
    {
        ...
        return redirect()->route('dashboard.pengguna.index')->with('success', 'Pengguna berhasil diperbarui');
    }
    ...
    public function updatePeminjaman(Request $request, $id)
    {
        ...
        return redirect()->route('dashboard.peminjaman.index')->with('success', 'Peminjaman berhasil diperbarui');
    }
